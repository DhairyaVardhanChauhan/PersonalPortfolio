...
const Profiles = () => {
  ...
  return (
    <div className="bg-transparent relative z-30 flex pr-2 justify-center items-center mt-8 space-x-8">
      ...
      >
        <GrLinkedin
          className={`text-[#45505b] font-extrabold text-[18px] cursor-pointer hover:text-blue transition-colors ease-in-out duration-300 hover:scale-110`}
        ></GrLinkedin>
      </a>
      <a href={links[1]} target="_blank" className="flex-shrink-0">
        <FaGithub
          className={`text-[#45505b] font-extrabold text-[20px] cursor-pointer hover:text-black transition-colors ease-in-out duration-300 hover:scale-110`}
        ></FaGithub>
      </a>
      <a href={links[2]} target="_blank" className="flex-shrink-0">
        <SiLeetcode
          className={`text-[#45505b] font-extrabold text-[20px] cursor-pointer hover:text-yellow-600 transition-colors ease-in-out duration-300 hover:scale-110`}
        ></SiLeetcode>
      </a>
