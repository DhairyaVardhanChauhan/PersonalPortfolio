const SkillHolder = ({ link, toolTipName, logoSize }) => {
  return (
    <div className="relative flex h-16 w-16 rounded-full mt-11 bg-custom-gradient items-center justify-center transition-all hover:translate-x-5 duration-300 mr-8 group hover:shadow-blue-shadow">
